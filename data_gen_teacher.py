...
parser.add_argument("-n","--num_teachers",type=int,default=64,help="number of teachers (ground agents)")
parser.add_argument( "-w", "--teacher_hidden_dim", type=int, default=16, help="number of teachers (ground agents)")
parser.add_argument( "-g", "--num_groups", type=int, default=64, help="number of coordinated teacher groups (abstract agents)")
parser.add_argument("-d", "--dim_state", type=int, default=64, help="state space dimension")
