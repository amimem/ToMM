...
parser.add_argument("-n","--num_teachers",type=int,default=128,help="number of teachers (ground agents)")
parser.add_argument( "-w", "--teacher_hidden_dim", type=int, default=32, help="number of teachers (ground agents)")
...
parser.add_argument("-s", "--num_states", type=int, default=2**20, help="number of states")
